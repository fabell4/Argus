...
- **Documentation fixes** — typos, formatting, broken links, incorrect examples
...
- **Dependency patch bumps** — automated Dependabot PRs for patch-level updates with no API changes
...
- **Breaking changes** — API, config schema, or Docker changes that affect users
...
- **New device support** — adding NUT, SNMP, or other poller integrations
- **New exporter or alert provider** — SQLite, Prometheus, InfluxDB, webhook, Gotify, ntfy, Apprise
