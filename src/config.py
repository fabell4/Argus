...
ALERT_ON_BATTERY: bool = _get_bool("ALERT_ON_BATTERY", True)
ALERT_ON_BATTERY_LOW: bool = _get_bool("ALERT_ON_BATTERY_LOW", True)
ALERT_ON_DEVICE_OFFLINE: bool = _get_bool("ALERT_ON_DEVICE_OFFLINE", True)
ALERT_RECOVERY_NOTIFICATIONS: bool = _get_bool("ALERT_RECOVERY_NOTIFICATIONS", True)
ALERT_RECOVERY_COOLDOWN_SECONDS: int = _get_int("ALERT_RECOVERY_COOLDOWN_SECONDS", 300)
ALERT_TEST_COOLDOWN_SECONDS: int = _get_int("ALERT_TEST_COOLDOWN_SECONDS", 10)
