...
Converts vulture, radon, semgrep, and pip-audit reports into SonarQube's
...
def main():
    ...
    write_report(
        convert_radon(args.radon, base),
        os.path.join(args.outdir, "sonar-radon.json"),
    )
    write_report(
